		...
		<div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 col-xs-offset-0 col-sm-offset-0 col-md-offset-1 col-lg-offset-1 toppad" style="text-align: center;" >
			<form method="post" enctype="multipart/form-data" id='myForm'>
						...
						<div class="row">
							...
							<div class="col-md-8 col-lg-9 "> 
								<table class="table table-user-information " >
										...
										<tr>
											<td>Nguyên liệu: </td>
											<td><input type="text" name="source" value="<?php echo $product->source ?>"></td>
										</tr>
										<tr>
				...
				<div class="panel-footer" align="center">
					...
					<button data-original-title="addproduct" data-toggle="tooltip" type="submit" class="btn btn-sm btn-warning">Lưu Sản Phẩm</i></button></div>
				</form>
			</div>
		</div>
	</div>
